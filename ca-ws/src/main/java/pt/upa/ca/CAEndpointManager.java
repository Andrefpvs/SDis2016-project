...
public class CAEndpointManager {
	...
	/** Port implementation */
	private CAPort portImpl;

	/** Obtain Port implementation */
	public CAPortType getPort() {
		return portImpl;
	}
	 ...
	 * @throws CASecondaryServerNotFoundException */
	public CAEndpointManager(String uddiURL, String wsName, String wsURL) throws JAXRException {
		this.uddiURL = uddiURL;
		this.wsName = wsName;
		this.wsURL = wsURL;
		this.portImpl = new CAPort(this);
	}

	/** constructor with provided web service URL */	
	public CAEndpointManager(String wsURL) {
		if (wsURL == null)
